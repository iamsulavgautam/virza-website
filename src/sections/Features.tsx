  ...
  return (
    <section className="py-24">
      <div className="container">
        ...
        <div className="mt-12 lg:grid-cols-3 grid grid-cols-1 gap-8 md:grid-cols-4  ">
          <FeatureCard
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature) => (
            <div
              key={feature}
              className="bg-neutral-900 md:px-5 md:py-2 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl gap-3 items-center"
            >
